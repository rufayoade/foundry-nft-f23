...
contract DeployMoodNftTest is Test {
    ...
    function testConvertSvgToUri() public view {
        ...
        string memory svg = '<svg xmlns="http://www.w3.org/2000/svg" width="500" height="500"><text x="200" y="250" fill="blue"> Hi! You decoded this!{" "}</text></svg>';
        ...
        string memory expectedUri = "data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSI1MDAiIGhlaWdodD0iNTAwIj48dGV4dCB4PSIyMDAiIHk9IjI1MCIgZmlsbD0iYmx1ZSI+IEhpISBZb3UgZGVjb2RlZCB0aGlzIXsiICJ9PC90ZXh0Pjwvc3ZnPg==";
